...
- Collapsed intelligence terminal shows **Click to open terminal** until the user expands it once or has sent a command (sessionStorage `projectr-agent-terminal-expanded-v1` remembers expand across reloads); first expanded view uses a full-sentence input placeholder instead of a lone `_` cursor.
