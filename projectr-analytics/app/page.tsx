  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        {/* AI Agent Chat — stay mounted so history survives close/reopen; hide when collapsed */}
        <div
          className={`pointer-events-none fixed z-50 flex max-h-[min(520px,72vh)] w-[min(360px,calc(100vw-1rem))] justify-start ${agentOpen ? '' : 'hidden'}`}
          style={{
